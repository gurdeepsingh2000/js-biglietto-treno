...
if (number_age < 18) {
    document.getElementById ('sconto').innerHTML = 'Questo è il prezzo scontato ' + '€' + deal_price_20.toFixed(2);
}

else if (number_age > 65) {
    document.getElementById ('sconto').innerHTML = 'Questo è il prezzo scontato ' + '€' + deal_40_price.toFixed(2);
}

else if (number_age >= 18 && number_age <= 65 ) {
    document.getElementById ('sconto').innerHTML = 'Prezzo non scontato ' + '€' + ticket_price.toFixed(2);
}